  ...
  class Liquid < Exchange
    ...
    async def fetch_currencies(params = {})
      ...
      for i in (0...response.length)
        ...
        precision = Math.max(amountPrecision, pricePrecision)
        result[code] = {
          'id' => id,
          'code' => code,
          'info' => currency,
    ...
    async def fetch_order_book(symbol, limit = nil, params = {})
      await{ self.load_markets }
      orderbook = await{ self.publicGetProductsIdPriceLevels(self.shallow_extend({
    ...
    async def fetch_ticker(symbol, params = {})
      ...
      ticker = await{ self.publicGetProductsId(self.shallow_extend({
        'id' => market['id']
      }, params)) }
    ...
    async def fetch_trades(symbol, since = nil, limit = nil, params = {})
      ...
      response = await{ self.publicGetExecutions(self.shallow_extend(request, params)) }
    ...
    async def fetch_my_trades(symbol = nil, since = nil, limit = nil, params = {})
      ...
      response = await{ self.privateGetExecutionsMe(self.shallow_extend(request, params)) }
    ...
    async def cancel_order(id, symbol = nil, params = {})
      await{ self.load_markets }
      result = await{ self.privatePutOrdersIdCancel(self.shallow_extend({
        'id' => id
      }, params)) }
    ...
    async def edit_order(id, symbol, type, side, amount, price = nil, params = {})
      ...
      result = await{ self.privatePutOrdersId(self.shallow_extend({
        'id' => id
      }, order)) }
    ...
    async def fetch_order(id, symbol = nil, params = {})
      await{ self.load_markets }
      order = await{ self.privateGetOrdersId(self.shallow_extend({
        'id' => id
      }, params)) }
    ...
    async def fetch_orders(symbol = nil, since = nil, limit = nil, params = {})
      ...
      result = await{ self.privateGetOrders(self.shallow_extend(request, params)) }
